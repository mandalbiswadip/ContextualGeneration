...
if __name__ == "__main__":
    ...
    training_set = CitationParagraphGenerationDataset(args.train_dataset, tokenizer,
                                  MAX_SENT_LEN=args.max_input_length, 
                                  include_intro=False,
                                  skip_no_citations=True, context_sep_flag=True)

    if args.distant_dataset is not None:
        distant_dataset = CitationParagraphGenerationDataset(args.distant_dataset, tokenizer,
                                  MAX_SENT_LEN=args.max_input_length, 
                                  include_intro=False,
                                  skip_no_citations=True, context_sep_flag=True)
