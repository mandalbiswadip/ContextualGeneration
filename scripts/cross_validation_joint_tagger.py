...
if __name__ == "__main__":
    ...
    for tr, dv in crossvalid(all_train, k_fold=args.k_fold):
        ...
        if train:
            ...
            k_fold_scores.append({
                "discourse_f1": best_scores[0][0],
                "discourse_precision": best_scores[0][1],
                "discourse_recall": best_scores[0][2],
                
                "citation_f1": best_scores[1][0],
                "citation_precision": best_scores[1][1],
                "citation_recall": best_scores[1][2],

                "span_f1": best_scores[2][0],
                "span_precision": best_scores[2][1],
                "span_recall": best_scores[2][2]
            })
            print("Kflod scores: \n", k_fold_scores[-1])            
    ...
    params["k_fold_results"] = k_fold_scores
